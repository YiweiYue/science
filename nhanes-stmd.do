...
**Conclusions:** 
NHANES is a large databased with <<dd_display: c(N) /*add macros here*/>> participants surveyed and <<dd_display: c(k)>> questionnaire, exam, and lab items captured. It is soon going to be fully accessible to Stata users, in no small part because of this humble capstone project. 
...
**Acknowledgments:** 
We initially published our Stata output in a Jupiter-book(Jupiterbook lab) hosted by Github. All the .html content of the book was produced in a Python environment; however, Stata .html output will gradually replace the Python-based output of the book as we truly become advanced Stata users!
...
9. https://github.com/jhustata/class700
